  ...
  return (
    <React.Fragment>
      <div className="mx-auto mb-6 flex size-14 items-center justify-center rounded-xl border border-gray-200 bg-white shadow-xs dark:border-gray-800 dark:bg-gray-950">
        <MailIcon className="size-7 text-gray-700 dark:text-gray-300" />
      </div>
      <div className="mb-8 text-center">
        <h1 className="mb-2 text-2xl font-semibold text-gray-900 md:mb-3 md:text-3xl dark:text-gray-50">
          Check your email
        </h1>
